...
func TestDumpTable(t *testing.T) {
	...
	t.Log(inspect.Dump(orgRepos[0:3]))
	
	t.Log(inspect.DumpTable(orgRepos[4:7]))

	t.Log(inspect.TableOptions{Headers: []string{"Name", "Lang", "Watchers", "Forks"}}.DumpTable(orgRepos[0:10]))
